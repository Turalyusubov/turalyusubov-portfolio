        ...
        <div className='bg-dark-green relative flex flex-col md:flex-row justify-center items-center py-20 h-screen w-full px-6 md:px-32'>
            <div className="header-left text-center">
                ...
                <div className="btns w-full justify-center flex gap-4 md:gap-8">
                    <button className='border-2 rounded-md bg-light-green text-dark-green drop-shadow-light font-bold md:px-8 py-2 border-light-green'>Hire Me</button>
                    <button className='border-2 rounded-md bg-transparent text-light-green drop-shadow-light font-bold md:px-8 py-2 border-light-green'>Let's Talk</button>
                </div>
