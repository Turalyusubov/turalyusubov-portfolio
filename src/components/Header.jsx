    ...
    return (
        <div className='bg-dark-green relative flex flex-col md:flex-row justify-center items-center py-20 h-full md:h-screen w-full px-6 md:px-32'>
            <div className="header-left">
                ...
                <p className='text-stone-100 mb-10'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium maiores enim provident temporibus nihil blanditiis expedita, praesentium possimus cum voluptas aliquid ad, totam ut placeat ullam, recusandae earum? At, natus?</p>
                <div className="btns flex gap-4 md:gap-8">
