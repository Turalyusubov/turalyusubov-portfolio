...
export default function About() {
    return (
        <div className='bg-main-green text-stone-100 relative flex flex-col justify-center items-center py-20 h-full md:h-screen w-full px-6 md:px-32'>
            ...
            <button className='border-2 flex  gap-2  items-center rounded-md bg-light-green drop-shadow-light text-dark-green font-bold md:px-8 py-2 border-light-green mt-8'>Resume <AiOutlineDownload className='text-xl' /></button>
        </div>
    )
}
